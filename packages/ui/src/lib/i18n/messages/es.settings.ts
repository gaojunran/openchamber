...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.keyboardShortcuts.action.jump_prev_user_message.label": "Saltar al mensaje de usuario anterior",
  "settings.openchamber.keyboardShortcuts.action.jump_next_user_message.label": "Saltar al siguiente mensaje de usuario",
