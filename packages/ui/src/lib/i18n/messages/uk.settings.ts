...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.keyboardShortcuts.action.jump_prev_user_message.label": "Перейти до попереднього повідомлення користувача",
  "settings.openchamber.keyboardShortcuts.action.jump_next_user_message.label": "Перейти до наступного повідомлення користувача",
