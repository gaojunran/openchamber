...
export const settingsDict = {
  ...
  'settings.openchamber.keyboardShortcuts.action.jump_prev_user_message.label': 'Przeskocz do poprzedniej wiadomości użytkownika',
  'settings.openchamber.keyboardShortcuts.action.jump_next_user_message.label': 'Przeskocz do następnej wiadomości użytkownika',
