...
export const dict: Record<I18nKey, string> = {
  ...
  "walkthrough.scope.basePickerTitle": "Selecione um branch base",
  "walkthrough.scope.basePickerDescription": "Percorra as mudanças deste branch comparadas a uma base que você escolher.",
  "walkthrough.scope.changeBase": "Alterar branch base...",
