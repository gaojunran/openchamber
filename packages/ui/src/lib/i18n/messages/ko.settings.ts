...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.keyboardShortcuts.action.jump_prev_user_message.label': '이전 사용자 메시지로 이동',
  'settings.openchamber.keyboardShortcuts.action.jump_next_user_message.label': '다음 사용자 메시지로 이동',
