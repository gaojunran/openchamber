...
export const dict = {
  ...
  'walkthrough.scope.basePickerTitle': 'Select a base branch',
  'walkthrough.scope.basePickerDescription': 'Walk through changes on this branch compared to a base you choose.',
  'walkthrough.scope.changeBase': 'Change base branch...',
