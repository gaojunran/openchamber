...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.keyboardShortcuts.action.jump_prev_user_message.label": "Pular para a mensagem anterior do usuário",
  "settings.openchamber.keyboardShortcuts.action.jump_next_user_message.label": "Pular para a próxima mensagem do usuário",
