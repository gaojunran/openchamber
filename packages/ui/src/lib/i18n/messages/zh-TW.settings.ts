...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.keyboardShortcuts.action.jump_prev_user_message.label': '跳轉到上一則使用者訊息',
  'settings.openchamber.keyboardShortcuts.action.jump_next_user_message.label': '跳轉到下一則使用者訊息',
