...
export const settingsDict = {
  ...
  'settings.openchamber.keyboardShortcuts.action.jump_prev_user_message.label': 'Jump to previous user message',
  'settings.openchamber.keyboardShortcuts.action.jump_next_user_message.label': 'Jump to next user message',
