...
export const settingsDict = {
  ...
  'settings.openchamber.keyboardShortcuts.action.jump_prev_user_message.label': 'Aller au message utilisateur précédent',
  'settings.openchamber.keyboardShortcuts.action.jump_next_user_message.label': 'Aller au message utilisateur suivant',
