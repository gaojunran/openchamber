...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.keyboardShortcuts.action.jump_prev_user_message.label': '跳转到上一条用户消息',
  'settings.openchamber.keyboardShortcuts.action.jump_next_user_message.label': '跳转到下一条用户消息',
