...
const SHORTCUT_GROUPS = {
  ...
  navigation: [
    ...
    },
    {
      ...
      defaultBinding: 'shift+pageup',
      customizable: true,
      settingsLabelKey:
        'settings.openchamber.keyboardShortcuts.action.jump_prev_user_message.label',
    },
    {
      id: 'jump_next_user_message',
      defaultBinding: 'shift+pagedown',
      customizable: true,
      settingsLabelKey:
        'settings.openchamber.keyboardShortcuts.action.jump_next_user_message.label',
    },
  ],
  application: [
    {
